    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Students extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(StudentsList, {ref: (ref) => this.list = ref, title: "Student computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, loadMethod: "LoadStudents", showBoxImport: () => this.showBoxImport(), showBoxNew: this.showBoxNew.bind(this), showBoxEdit: this.showBoxEdit.bind(this), disableClass: this.disableClass.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(StudentsBox, {ref: (ref) => this.box = ref, title: "Student computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}), React.createElement(StudentsImportBox, {ref: (ref) => this.boxImport = ref, title: "Import Student computers", classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
