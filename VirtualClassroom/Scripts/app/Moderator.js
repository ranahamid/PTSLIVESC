    ...
    (function (App) {
        ...
        class PC extends App.XC {
            ...
            render() {
                ...
                return (React.createElement("div", {className: "pcContainer"}, React.createElement("div", {ref: (ref) => this.divStatus = ref}, React.createElement(App.Components.Status, {ref: (ref) => this.status = ref, text: "Connecting ...", style: App.Components.StatusStyle.Connecting, className: "cStatus", statusClasses: statusClasses})), React.createElement("div", {ref: (ref) => this.divUI = ref, style: { display: "none" }, className: "layout"}, React.createElement("table", {width: "100%", frameBorder: "0"}, React.createElement("tr", null, React.createElement("td", null, React.createElement("div", {ref: (ref) => this.divMain = ref, className: "main"}, React.createElement(App.Components.Box, {ref: (ref) => this.boxSubscriber = ref, id: this.props.targetId + "_Subscriber1", streamProps: this.subscribeProps, className: "cBox", visible: true}), React.createElement(App.Components.BoxLabel, {ref: (ref) => this.label = ref, text: "", style: App.Components.BoxLabelStyle.NoIcon, className: "cBoxLabel", labelClasses: labelClasses, visible: true})), React.createElement("div", {ref: (ref) => this.divFrame = ref, className: "frame"}, React.createElement("div", {ref: (ref) => this.divButtons = ref, className: "divButtons"}, React.createElement("div", null, React.createElement(App.Components.SwitchButton, {ref: (ref) => this.switchButtonVideo = ref, textOn: "", textOff: "", classOn: "btn btn-success", classOff: "btn btn-danger", iconOn: "glyphicon facetime-video-on", iconOff: "glyphicon facetime-video-off", status: App.Components.SwitchButtonStatus.Hidden, onOn: () => { this.turnAv(null, false); }, onOff: () => { this.turnAv(null, true); }, className: "avButton", delayed: 500})), React.createElement("div", null, React.createElement(App.Components.SwitchButton, {ref: (ref) => this.switchButtonAudio = ref, textOn: "", textOff: "", classOn: "btn btn-success", classOff: "btn btn-danger", iconOn: "glyphicon music-on", iconOff: "glyphicon music-off", status: App.Components.SwitchButtonStatus.Hidden, onOn: () => { this.turnAv(false, null); }, onOff: () => { this.turnAv(true, null); }, className: "avButton", delayed: 500})), React.createElement("div", null, React.createElement(App.Components.SwitchButton, {ref: (ref) => this.switchButtonHand = ref, textOn: "", textOff: "", classOn: "btn btn-success ", classOff: "btn btn-danger ", iconOn: "glyphicon rise-hand-on", iconOff: "glyphicon rise-hand-off", status: App.Components.SwitchButtonStatus.Start, onOn: this.raiseHand.bind(this), onOff: this.lowerHand.bind(this), className: "handButton", delayed: 500}))), React.createElement("div", {className: 'header-button2'}, React.createElement("span", {id: "video-text"}, "Video"), React.createElement("button", {id: 'minimizevideo'}, React.createElement("i", {class: "fa fa-window-minimize", "aria-hidden": "true"}))), React.createElement(App.Components.Box, {ref: (ref) => this.boxPublisher = ref, id: this.props.targetId + "_Publisher1", streamProps: this.publishProps, className: "cBoxP", visible: true}), React.createElement(App.Components.Chat, {ref: (ref) => this.chatPublic = ref, title: "Message Cohort (Public)", fixedHeight: true, onItemSubmitted: (item) => this.onChatPublicItemSubmitted(item)}))))))));
            }
        }
        class InitModerator {
