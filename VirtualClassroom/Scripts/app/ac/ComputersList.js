        ...
        (function (AC) {
            ...
            class ComputersList extends React.Component {
                ...
                renderComputers() {
                    ...
                    if (items.length > 0) {
                        if (this.state.selectedRole === App.Roles.PC) {
                            return (React.createElement("table", {className: "table", align: "center"}, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {style: { width: "30%" }}, "Student computer"), React.createElement("th", {style: { width: "15%" }}, "Volume"), React.createElement("th", {style: { width: "15%" }}, "Hands"), React.createElement("th", {style: { width: "40%" }}, this.renderComputerAllButtons(this.state.selectedRole)))), React.createElement("tbody", null, items)));
                        }
