...
namespace VC.Admin.Lists {
    ...
    export class Surveys extends Base<string, IFormsListItem, FormsList, FormsBox> {
        ...
        render(): JSX.Element {
            return (
                <div>
                    <FormsList ref={(ref: FormsList) => this.list = ref} title="Survey" actionUrl={this.props.actionUrl}  classroomId={this.props.classroomId} loadMethod="LoadSurveys" showBoxNew={this.showBoxNew.bind(this) } showBoxEdit={this.showBoxEdit.bind(this) } showBoxDelete={this.showBoxDelete.bind(this) } />
    ...
    export class Polls extends Base<string, IFormsListItem, FormsList, FormsBox> {
        ...
        render(): JSX.Element {
            return (
                <div>
                    <FormsList ref={(ref: FormsList) => this.list = ref} title="Poll" actionUrl={this.props.actionUrl}  classroomId={this.props.classroomId} loadMethod="LoadPolls" showBoxNew={this.showBoxNew.bind(this) } showBoxEdit={this.showBoxEdit.bind(this) } showBoxDelete={this.showBoxDelete.bind(this) } />
