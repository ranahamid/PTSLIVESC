    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Seats extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(SeatsList, {ref: (ref) => this.list = ref, title: "Seat computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, loadMethod: "LoadSeats", showBoxImport: () => this.showBoxImport(), showBoxNew: this.showBoxNew.bind(this), disableClass: this.disableClass.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(SeatsBox, {ref: (ref) => this.box = ref, title: "Seat computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}), React.createElement(SeatsImportBox, {ref: (ref) => this.boxImport = ref, title: "Import Seat computers", classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
            Lists.Seats = Seats;
