    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Moderators extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(ModeratorsList, {ref: (ref) => this.list = ref, title: "Moderator computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, loadMethod: "LoadModerators", showBoxImport: () => this.showBoxImport(), showEnableClass: this.showEnableClass.bind(this), showDisableClass: this.showDisableClass.bind(this), showBoxNew: this.showBoxNew.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(ModeratorsBox, {ref: (ref) => this.box = ref, title: "Moderator computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}), React.createElement(ModeratorsImportBox, {ref: (ref) => this.boxImport = ref, title: "Import Moderator computers", classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
            Lists.Moderators = Moderators;
            class ModeratorsList extends Lists.List {
                renderItemCols(d) {
                    let l = [];
                    l.push(React.createElement("td", {key: "tdId_" + d.id}, d.id));
                    l.push(React.createElement("td", {key: "tdName_" + d.id}, d.name));
                ...
                renderTableHeaderCols() {
                    let l = [];
                    l.push(React.createElement("th", {key: "thId"}, "ID"));
                    l.push(React.createElement("th", {key: "thModerator"}, "Moderator computer"));
                    return l;
                }
            }
            class ModeratorsBox extends Lists.Box {
                constructor(props) {
                    super({ id: "", name: "" }, props);
                }
                boxWillShow() {
            ...
            class ModeratorsImportBox extends Lists.ImportBox {
                constructor(props) {
                    super(props);
                }
                renderHelp() {
