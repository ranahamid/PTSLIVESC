    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Featureds extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(FeaturedsList, {ref: (ref) => this.list = ref, title: "Featured computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, loadMethod: "LoadFeatureds", showBoxImport: () => this.showBoxImport(), showBoxNew: this.showBoxNew.bind(this), showDisableClass: this.showDisableClass.bind(this), showEnableClass: this.showEnableClass.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(FeaturedsBox, {ref: (ref) => this.box = ref, title: "Featured computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}), React.createElement(FeaturedsImportBox, {ref: (ref) => this.boxImport = ref, title: "Import Featured computers", classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
