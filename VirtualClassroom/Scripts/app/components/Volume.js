    ...
    (function (App) {
        ...
        (function (Components) {
            ...
            class Volume extends React.Component {
                ...
                render() {
                    return (React.createElement("div", {className: "cVolume", style: { display: this.props.display ? "block" : "none" }}, React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", {className: "tbBtn", style: { borderTop: "0px" }}, React.createElement("button", {type: "button", disabled: this.state.volume === 0, className: this.state.volume > 0 ? "btn btn-xs btn-info" : "btn btn-xs btn-danger", onClick: () => this.decreaseVolume()}, React.createElement("span", {className: this.state.volume > 0 ? "glyphicon glyphicon-volume-down" : "glyphicon glyphicon-volume-off"}))), React.createElement("td", {className: "tbVol", style: { borderTop: "0px" }}, React.createElement("div", {ref: (ref) => this.progressBar = ref, className: "progress progressBar", onClick: (e) => this.barClick(e)}, React.createElement("div", {className: "progress-bar progress-bar-success progressBarInner", role: "progressbar", style: { width: this.state.volume + "%" }}, this.state.volume, "%"))), React.createElement("td", {className: "tbBtn", style: { borderTop: "0px" }}, React.createElement("button", {type: "button", disabled: this.state.volume === 100, className: this.state.volume < 100 ? "btn btn-xs btn-info" : "btn btn-xs btn-success", onClick: () => this.increaseVolume()}, React.createElement("span", {className: "glyphicon glyphicon-volume-up"}))))))));
                }
            }
