    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Classrooms extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(ClassroomsList, {ref: (ref) => this.list = ref, title: "Classroom", actionUrl: this.props.actionUrl, loadMethod: "Load", showBoxNew: this.showBoxNew.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(ClassroomsBox, {ref: (ref) => this.box = ref, title: "Classroom", actionUrl: this.props.actionUrl, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
