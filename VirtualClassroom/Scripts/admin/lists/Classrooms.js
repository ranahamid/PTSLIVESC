        ...
        (function (Lists) {
            ...
            class Classrooms extends Lists.Base {
                ...
                render() {
                    ...
                    return (React.createElement("div", null, React.createElement("div", null, React.createElement(VC.Global.Components.Tabs, {ref: (ref) => this.tabs = ref, items: tabItems, className: "cTabs"})), React.createElement("div", null, React.createElement(ClassroomsList, {ref: (ref) => this.list = ref, title: "Classroom", actionUrl: this.props.actionUrl, loadMethod: "Load", showBoxImport: () => this.showBoxImport(), showBoxNew: this.showBoxNew.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(ClassroomsBox, {ref: (ref) => this.box = ref, title: "Classroom", actionUrl: this.props.actionUrl, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}), React.createElement(ClassroomsImportBox, {ref: (ref) => this.boxImport = ref, title: "Import Classrooms", classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)}))));
                }
            }
