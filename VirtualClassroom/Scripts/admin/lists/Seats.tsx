            ...
            return (
                <form className="form-horizontal" role="form">
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT1} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT1} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT2} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT2} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT3} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT3} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT4} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT4} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT5} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT5} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT6} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT6} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT7} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT7} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT8} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT8} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableSeatStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
