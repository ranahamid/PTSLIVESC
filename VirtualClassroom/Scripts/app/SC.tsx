            ...
            return (
                <div className="scContainer">
                    ...
                    <div ref={(ref: HTMLDivElement) => this.divUI = ref} style={{ display: "none" }}>
                        <Components.Box ref={(ref: Components.Box) => this.boxPublisher = ref} id={this.props.targetId + "_Publisher1"} streamProps={this.publishProps} className="" visible={false} style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses} />
                                                                                                                                                                                                             
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[0] = ref} id={this.props.targetId + "_Subscriber1"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[1] = ref} id={this.props.targetId + "_Subscriber2"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[2] = ref} id={this.props.targetId + "_Subscriber3"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[3] = ref} id={this.props.targetId + "_Subscriber4"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[4] = ref} id={this.props.targetId + "_Subscriber5"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[5] = ref} id={this.props.targetId + "_Subscriber6"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[6] = ref} id={this.props.targetId + "_Subscriber7"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
                        <Components.Box ref={(ref: Components.Box) => this.boxSubscribers[7] = ref} id={this.props.targetId + "_Subscriber8"} streamProps={this.subscribeProps} className="cBox" visible={false}style={Components.BoxStyle.NotConnected} BoxClasses={labelClasses}/>
