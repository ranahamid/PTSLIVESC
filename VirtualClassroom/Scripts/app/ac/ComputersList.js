    ...
    (function (App) {
        ...
        (function (AC) {
            ...
            class ComputersList extends React.Component {
                ...
                renderComputer(item) {
              return (React.createElement("tr", {key: "tr_" + item.uid}, React.createElement("td", null, React.createElement("div", null, React.createElement("span", {className: "glyphicon glyphicon-link", style: { color: "green" }}), " ", React.createElement("span", {className: (item.handRaised ? "glyphicon glyphicon-hand-up" : "glyphicon glyphicon-hand-down"), style: { color: (item.handRaised ? "red" : "gray"), display: (this.state.selectedRole === App.Roles.PC ? "inline-block" : "none") }}), " ", item.name)), React.createElement("td", {style: { display: (this.state.selectedRole === App.Roles.PC || this.state.selectedRole === App.Roles.TC ? "block" : "none") }}, React.createElement(App.Components.Volume, {ref: "RefVolumeBar_" + item.uid, volume: item.video !== undefined ? item.volume : 0, display: item.video !== undefined, onVolumeChanged: (vol) => this.props.changeVolume(item.uid, vol)})), React.createElement("td", {style: { textAlign: "right" }}, React.createElement("div", {className: "cListButton"}, React.createElement("button", {type: "button", className: "btn btn-xs btn-warning", onClick: () => this.props.turnOff(item.uid)}, React.createElement("span", {className: "glyphicon glyphicon-off"}))), React.createElement("div", {className: "cListButton", style: { display: "none" }}, React.createElement("button", {type: "button", className: "btn btn-xs btn-default", disabled: "true"}, React.createElement("span", {className: "glyphicon glyphicon-record"}))), React.createElement("div", {className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC || this.state.selectedRole === App.Roles.SC ? "none" : "block") }}, React.createElement(App.Components.SwitchButton, {textOn: "", textOff: "", classOn: "btn btn-xs btn-danger", classOff: "btn btn-xs btn-success", iconOn: "glyphicon glyphicon-facetime-video", iconOff: "glyphicon glyphicon-facetime-video", status: this.getButtonStatus(item.video), onOn: () => this.props.turnAv(item.uid, null, true), onOff: () => this.props.turnAv(item.uid, null, false), className: ""})), React.createElement("div", {className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC || this.state.selectedRole === App.Roles.SC ? "none" : "block") }}, React.createElement(App.Components.SwitchButton, {textOn: "", textOff: "", classOn: "btn btn-xs btn-danger", classOff: "btn btn-xs btn-success", iconOn: "glyphicon glyphicon-music", iconOff: "glyphicon glyphicon-music", status: this.getButtonStatus(item.audio), onOn: () => this.props.turnAv(item.uid, true, null), onOff: () => this.props.turnAv(item.uid, false, null), className: ""})), React.createElement("div", {className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC ? "block" : "none") }}, React.createElement("button", {type: "button", className: "btn btn-xs btn-info", onClick: () => this.props.featuredComputerClick(item.uid, item.name)}, React.createElement("span", {className: "glyphicon glyphicon-th"}))))));
// data will be insert into this line
             //       return (React.createElement("tr", { key: "tr_" + item.uid }, React.createElement("td", null, React.createElement("div", null, React.createElement("span", { className: "glyphicon glyphicon-link", style: { color: "green" } }), " ", React.createElement("span", { className: (item.handRaised ? "glyphicon glyphicon-hand-up" : "glyphicon glyphicon-hand-down"), style: { color: (item.handRaised ? "red" : "gray"), display: (this.state.selectedRole === App.Roles.PC ? "inline-block" : "none") } }), " ", item.name)), React.createElement("td", { style: { display: (this.state.selectedRole === App.Roles.PC || this.state.selectedRole === App.Roles.TC ? "block" : "none") } }, React.createElement(App.Components.Volume, { ref: "RefVolumeBar_" + item.uid, volume: item.video !== undefined ? item.volume : 0, display: item.video !== undefined, onVolumeChanged: (vol) => this.props.changeVolume(item.uid, vol) })), React.createElement("td", { style: { textAlign: "right", display: (this.state.selectedRole === App.Roles.PC ? "0" : "none") } }, React.createElement('span', {}, 'Seat 61*' + item.name)), React.createElement("td", { style: { textAlign: "right" } }, React.createElement("div", { className: "cListButton" }, React.createElement("button", { type: "button", className: "btn btn-xs btn-warning", onClick: () => this.props.turnOff(item.uid) }, React.createElement("span", { className: "glyphicon glyphicon-off" }))), React.createElement("div", { className: "cListButton", style: { display: "none" } }, React.createElement("button", { type: "button", className: "btn btn-xs btn-default", disabled: "true" }, React.createElement("span", { className: "glyphicon glyphicon-record" }))), React.createElement("div", { className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC || this.state.selectedRole === App.Roles.SC ? "none" : "block") } }, React.createElement(App.Components.SwitchButton, { textOn: "", textOff: "", classOn: "btn btn-xs btn-danger", classOff: "btn btn-xs btn-success", iconOn: "glyphicon glyphicon-facetime-video", iconOff: "glyphicon glyphicon-facetime-video", status: this.getButtonStatus(item.video), onOn: () => this.props.turnAv(item.uid, null, true), onOff: () => this.props.turnAv(item.uid, null, false), className: "" })), React.createElement("div", { className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC || this.state.selectedRole === App.Roles.SC ? "none" : "block") } }, React.createElement(App.Components.SwitchButton, { textOn: "", textOff: "", classOn: "btn btn-xs btn-danger", classOff: "btn btn-xs btn-success", iconOn: "glyphicon glyphicon-music", iconOff: "glyphicon glyphicon-music", status: this.getButtonStatus(item.audio), onOn: () => this.props.turnAv(item.uid, true, null), onOff: () => this.props.turnAv(item.uid, false, null), className: "" })), React.createElement("div", { className: "cListButton", style: { display: (this.state.selectedRole === App.Roles.FC ? "block" : "none") } }, React.createElement("button", { type: "button", className: "btn btn-xs btn-info", onClick: () => this.props.featuredComputerClick(item.uid, item.name) }, React.createElement("span", { className: "glyphicon glyphicon-th" }))))));
                }
                ...
                renderComputers() {
                    ...
                    if (items.length > 0) {
                        if (this.state.selectedRole === App.Roles.PC) {
                            return (React.createElement("table", { className: "table", align: "center" }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", { style: { width: "40%" } }, "Student computer"), React.createElement("th", null, "Volume"),  React.createElement("th", null, this.renderComputerAllButtons(this.state.selectedRole)))), React.createElement("tbody", null, items)));
                        }
