        ...
        (function (PC) {
            ...
            class FormBox extends React.Component {
                constructor(props) {
                    super(props);
                    this.showBox = false;
                    this.state = { formId: "", answerId: "", title: "", status: undefined };
                }
                componentDidMount() {
                ...
                open(formId, answerId, title, status) {
                    this.showBox = true;
                    ...
                    this.setState({ title: title, answerId: answerId, status: status, formId: formId });
                }
                hide() {
                ...
                submitAnswer() {
                    if (this.form.validate()) {
                        ...
                        VC.Forms.FormApi.UpdateAnswer({ uid: this.state.answerId, formData: data, status: VC.Forms.FormAnswerStatus.Answered }, () => {
                            // success
                            this.hide();
                            this.props.onAnswerSubmitted(this.state.answerId, this.state.formId);
                        }, (error) => {
                            // error
                            alert(error);
                            this.hide();
                ...
                declineAnswer() {
                    ...
                    VC.Forms.FormApi.UpdateAnswer({ uid: this.state.answerId, status: VC.Forms.FormAnswerStatus.Declined }, () => {
                        // success
                        this.hide();
                        this.props.onAnswerDeclined(this.state.answerId, this.state.formId);
                    }, (error) => {
                        // error
                        alert(error);
                        this.hide();
                ...
                render() {
                    return (React.createElement("div", {ref: (ref) => this.divBox = ref, className: "modal fade", role: "dialog"}, React.createElement("div", {className: "modal-dialog"}, React.createElement("div", {className: "modal-content"}, React.createElement("div", {className: "modal-header"}, React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal"}, "× "), React.createElement("h4", {className: "modal-title"}, this.state.title, " ", this.renderBoxStatus(this.state.status))), React.createElement("div", {className: "modal-body"}, React.createElement(VC.Forms.Form, {ref: (ref) => this.form = ref, view: VC.Forms.FormViews.Preview, type: VC.Forms.FormType.Survey})), React.createElement("div", {ref: (ref) => this.divButtons = ref, style: { display: "block" }, className: "modal-footer"}, this.renderBoxButtons(this.state.status)), React.createElement("div", {ref: (ref) => this.divProcessing = ref, style: { display: "none" }, className: "modal-footer"}, React.createElement("span", null, "Processing ..."))))));
                }
            }
            class FormsPc extends React.Component {
                ...
                onViewClick(item) {
                    this.formBox.open(item.formId, item.id, item.title, item.status);
                }
                onAnswerSubmitted(answerId, formId) {
                    this.answersList.updateAnswerStatus(answerId, VC.Forms.FormAnswerStatus.Answered);
                    this.props.onAnswerStatusChanged(formId, answerId, VC.Forms.FormAnswerStatus.Answered);
                }
                onAnswerDeclined(answerId, formId) {
                    this.answersList.updateAnswerStatus(answerId, VC.Forms.FormAnswerStatus.Declined);
                    this.props.onAnswerStatusChanged(formId, answerId, VC.Forms.FormAnswerStatus.Declined);
                }
                formReceived() {
                    this.answersList.updateList();
                }
                render() {
                    return (React.createElement("div", null, React.createElement("div", {ref: (ref) => this.divAnswersList = ref}, React.createElement(AnswersList, {ref: (ref) => this.answersList = ref, onViewClick: (item) => this.onViewClick(item), onPendingAnswersChanged: (count) => this.props.onPendingAnswersChanged(count), actionUrl: this.props.actionUrl})), React.createElement(FormBox, {ref: (ref) => this.formBox = ref, onAnswerSubmitted: (answerId, formUid) => this.onAnswerSubmitted(answerId, formUid), onAnswerDeclined: (answerId, formUid) => this.onAnswerDeclined(answerId, formUid)})));
                }
            }
            PC.FormsPc = FormsPc;
        })(PC = App.PC || (App.PC = {}));
