        ...
        (function (Lists) {
            ...
            class StudentsList extends Lists.List {
                renderItemCols(d) {
                    ...
                    l.push(React.createElement("td", {key: "td_featuredpcname" + d.id}, d.featured === null ? "-" : d.featured.name));
