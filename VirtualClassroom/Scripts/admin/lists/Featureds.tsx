...
namespace VC.Admin.Lists {
    ...
    interface IFeaturedsListProps extends IListProps<string> { }
    interface IFeaturedsListState extends IListState<IFeaturedsListItem> { }
    ...
    interface IFeaturedsBoxProps extends IBoxProps<IFeaturedsListItem> { }
    interface IFeaturedsBoxState extends IBoxState<IFeaturedsListItem> { }

    class FeaturedsBox extends Box<string, IFeaturedsListItem, IFeaturedsBoxProps, IFeaturedsBoxState> {

        constructor(props: IFeaturedsBoxProps) {
            super({ id: "", name: "", students: null } as IFeaturedsListItem,
                props);
        }
        ...
        boxWillShow(): void {
            ...
            let tbStudent1: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT1] as Components.Selector;
            let tbStudent2: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT2] as Components.Selector;
            let tbStudent3: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT3] as Components.Selector;
            let tbStudent4: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT4] as Components.Selector;
            let tbStudent5: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT5] as Components.Selector;
            let tbStudent6: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT6] as Components.Selector;
            let tbStudent7: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT7] as Components.Selector;
            let tbStudent8: Components.Selector = this.refs[REF_FORM_TB + FORM_STUDENT8] as Components.Selector;
        ...
        validateId(focusOnError: boolean): boolean {
            ...
            if (this.state.type === BoxTypes.Create) {
                ...
                if (this.isIdValid(idVal)) {
                    ...
                    this.setValidationStatus(FORM_ID, BoxValidationStatus.Error, "Featured computer Id cannot be empty. It must be unique and contains only alphanumeric characters.");
                    if (focusOnError) {
                        $(tbId).focus();
                    }
                    valid = false;
        ...
        validateName(focusOnError: boolean): boolean {
            ...
            if (this.state.type === BoxTypes.Create || this.state.type === BoxTypes.Edit) {
                ...
                if (this.isNameValid(nameVal)) {
                    ...
                    this.setValidationStatus(FORM_NAME, BoxValidationStatus.Error, "Featured computer name cannot be empty.");
                    if (focusOnError) {
                        $(tbName).focus();
                    }
                    valid = false;
        ...
        submitFormIdValidated(exist: boolean): void {
            if (exist) {
                ...
                this.setValidationStatus(FORM_ID, BoxValidationStatus.Error, "Featured Id already exists.");
                $(tbId).focus();
            } else {
                // create
                this.doCreate();
            ...
            $.ajax({
                ...
                success: (r: Global.Data.IDataResponse<string>): void => {
                    ...
                    if (r.status === Global.Data.RESPONSE_SUCCESS) {
                        // remove from list
                        let d: Array<IFeaturedsListItem> = this.props.getListItems();
                        let _d: Array<IFeaturedsListItem> = [];
                        for (let i: number = 0; i < d.length; i++) {
                            if (d[i].id !== this.state.item.id) {
                                _d.push(d[i]);
                            }
            ...
            return (
                <form className="form-horizontal" role="form">
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT1} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT1} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT2} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT2} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT3} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT3} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT4} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT4} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT5} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT5} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT6} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT6} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT7} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT7} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
                    ...
                    <div ref={REF_FORM_DIV + FORM_STUDENT8} className="form-group">
                        ...
                        <div className="col-sm-10">
                            <Components.Selector ref={REF_FORM_TB + FORM_STUDENT8} actionUrl={this.props.actionUrl} classroomId={this.props.classroomId} loadAction="GetAvailableFeaturedStudents" defaultName="Select Student computer" onSelectedItemChanged={this.onSelectedStudentChanged.bind(this) } className="form-control" />
