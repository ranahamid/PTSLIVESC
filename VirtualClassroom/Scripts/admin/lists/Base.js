    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class List extends React.Component {
                ...
                renderItem(d) {
                    return (React.createElement("tr", {key: d.id}, this.renderItemCols(d), React.createElement("td", {style: { textAlign: "right", width: "25%" }}, React.createElement("button", {type: "button", className: "btn btn-sm btn-info", onClick: () => this.props.showBoxEdit(d.id)}, React.createElement("span", {className: "glyphicon glyphicon-pencil"}), "Edit"), " ", React.createElement("button", {type: "button", id: "showDisableClass", style: { display: "none" }, className: "showDisableClass btn btn-sm btn-warning", onClick: () => this.props.showDisableClass(d.id)}, React.createElement("span", {className: "glyphicon glyphicon-minus-sign"}), "Disable"), " ", React.createElement("button", {type: "button", id: "showEnableClass", style: { display: "none" }, className: "showEnableClass btn btn-sm btn-success", onClick: () => this.props.showEnableClass(d.id)}, React.createElement("span", {className: "glyphicon glyphicon-plus-sign"}), "Enable"), " ", React.createElement("button", {type: "button", className: "btn btn-sm btn-danger", onClick: () => this.props.showBoxDelete(d.id)}, React.createElement("span", {className: "glyphicon glyphicon-trash"}), "Delete"))));
                }
                renderTable() {
                    let items = [];
