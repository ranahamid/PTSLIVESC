    ...
    (function (Admin) {
        ...
        (function (Lists) {
            ...
            class Teachers extends Lists.Base {
                ...
                render() {
                    return (React.createElement("div", null, React.createElement(TeachersList, {ref: (ref) => this.list = ref, title: "Teacher computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, loadMethod: "LoadTeachers", showBoxNew: this.showBoxNew.bind(this), showBoxEdit: this.showBoxEdit.bind(this), showBoxDelete: this.showBoxDelete.bind(this)}), React.createElement(TeachersBox, {ref: (ref) => this.box = ref, title: "Teacher computer", actionUrl: this.props.actionUrl, classroomId: this.props.classroomId, getListItems: this.getListItems.bind(this), setListItems: this.setListItems.bind(this)})));
                }
            }
